...
| :--- | :--- | :--- | :--- | :--- |
| **[US-GAME-18a](../user-stories/US-GAME-18a.md)** | **Staff สร้างห้องเกม (Game Room)**<br>- สร้าง Room Code 6 หลัก และหน้าจอจัดการของ Host | Developer | 12 hrs | [ ] |
| **[US-GAME-18b](../user-stories/US-GAME-18b.md)** | **ผู้เข้าร่วม Join ด้วย QR หรือ Room Code**<br>- ตั้งชื่อเล่น/เข้าร่วมโดยไม่ต้องลงชื่อเข้าใช้งานหลัก | Developer | 8 hrs | [ ] |
| **[US-GAME-18c](../user-stories/US-GAME-18c.md)** | **Host เห็นรายชื่อผู้เข้าร่วมแบบ Live Lobby**<br>- หน้าจอรอล็อบบี้อัปเดตแบบเรียลไทม์ | Developer | 6 hrs | [ ] |
...
| **[US-GAME-18g](../user-stories/US-GAME-18g.md)** | **Leaderboard แสดงคะแนนและสรุปผล**<br>- ตารางแสดงคะแนนพร้อมการจัดอันดับสะสมข้ามรอบ | Developer | 8 hrs | [ ] |
...
| **[US-GAME-18i](../user-stories/US-GAME-18i.md)** | **ระบบแอดมินปิดห้องเกมเมื่อจบเกม**<br>- บันทึกผลเกมไว้ฝั่งเซิร์ฟเวอร์ก่อนตัดการเชื่อมต่อ | Developer | 6 hrs | [ ] |
