...
4. [x] ผู้เล่นฝั่งรอเห็นหมากคู่แข่งช้าสุด ~2.5 วิ — **ยืนยันเรียบร้อย**
5. [x] Request ต่อห้องต่อนาทีในโหมด fallback ไม่เกิน ~30 req/นาที — **ยืนยันเรียบร้อย**
...
- [x] วัด req/นาที และ latency การเห็นหมาก ก่อน/หลัง บน local — **ยืนยันเรียบร้อย**
