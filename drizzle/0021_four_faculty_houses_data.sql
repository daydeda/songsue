-- 0021: Single-faculty (CAMT) → 4-faculty house model.
--
...
-- 0020_four_faculty_houses.sql. THIS file carries only the DATA migration
...
-- file mirrors steps 62-65 for parity with the drizzle/ migration history.
...
-- 62. Backfill the 4 EXISTING CAMT house rows. Their ids ('red'/'green'/
...
-- 63. Insert the 12 new faculty houses (MASSCOM/ARCH/ARTS × red/green/yellow/blue).
...
-- 65. Reset the per-user current-house pointer so everyone re-derives their house
