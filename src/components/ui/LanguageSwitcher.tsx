          ...
          return (
            <button
              ...
              style={{
                ...
                boxShadow: isActive ? "0 4px 12px rgba(0,0,0,0.08), 0 2px 4px rgba(0,0,0,0.04)" : "none",
    ...
    <div style={{ position: "relative", width: "fit-content" }} ref={dropdownRef}>
      <button
        ...
        style={{
          ...
          height: 44,
          borderRadius: 14,
          background: isOpen ? "var(--bg-elevated)" : "rgba(0,0,0,0.05)",
          ...
          {languages.map((l) => (
            <button
              ...
              style={{
                ...
                background: lang === l.code ? "rgba(0,0,0,0.08)" : "transparent",
